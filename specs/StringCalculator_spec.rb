...
describe StringCalculator do
    context "Invoke #add method" do
        ...
        it 'throws an exception for negative numbers' do
            expect { subject.add("1,-2") }.to raise_error(ArgumentError, "Negative numbers not allowed: -2")
        end

        it 'throws an exception for multiple negative numbers' do
            expect { subject.add("1,-2,3,-4") }.to raise_error(ArgumentError, "Negative numbers not allowed: -2, -4")
        end
end